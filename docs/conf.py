...
g = {}
with open(os.path.join("..", "reana_workflow_engine_serial", "version.py"), "rt") as fp:
    exec(fp.read(), g)
...
#
html_theme_options = {
    "description": """<p>REANA-Workflow-Engine-Serial is a component of the <a
                      href="http://www.reana.io">REANA</a> reusable and
                      reproducible research data analysis
                      platform.</p><p>REANA-Workflow-Engine-Serial takes care
                      of instantiating, executing and managing simple
                      sequential computational workflows.</p>""",
    "github_user": "reanahub",
    "github_repo": "reana-workflow-engine-serial",
    "github_button": False,
    "github_banner": True,
